...
export const settings = definePluginSettings({
    ...
    personality: {
        type: OptionType.SELECT,
        description: "Reply personality (character), separate from tone",
        options: [
    ...
    customPersonality: {
        type: OptionType.STRING,
        description: "Custom personality description (used when personality = Custom)",
        default: "",
        hidden: () => settings.store.personality !== "custom",
    },
    length: {
        type: OptionType.SELECT,
    ...
    filterSlurs: {
        type: OptionType.BOOLEAN,
        description: "Mask slurs / hate terms in gathered messages before sending to the AI",
        default: true,
    },
    extraInstructions: {
        type: OptionType.STRING,
